 ...
 * @author Ed. Chamo
 */
public class RedBlackT<E extends Comparable<E>>
{
    /**
     * The left child of this node, or EMPTY
     */
    protected RedBlackT<E> left;

    /**
     * The right child of this node, or EMPTY
     */
    protected RedBlackT<E> right;

    /**
     * The parent of this node, or null
     */
    protected RedBlackT<E> parent;
     ...
     */
    public static final RedBlackT EMPTY = new RedBlackT<String>();
